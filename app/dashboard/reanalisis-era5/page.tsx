...
export default function ReanalysisPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* 1. Page Header Banner (Single Compact Banner) */}
      <PageHeaderBanner
        gradient="purple"
        badgeText="ECMWF Fifth Generation Global Atmospheric Reanalysis"
        icon={Compass}
        title="Reanalisis Klimatologi ERA5"
        subtitle="Dataset reanalisis iklim global generasi kelima dari ECMWF (1940 - sekarang). Menyediakan analisis komprehensif parameter meteorologi dan klimatologi beresolusi tinggi di seluruh lokasi Indonesia."
        actions={
          appliedCoords ? (
