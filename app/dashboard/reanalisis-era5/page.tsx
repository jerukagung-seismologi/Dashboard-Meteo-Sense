...
export default function ReanalysisPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 bg-gradient-to-r from-purple-900 via-slate-900 to-slate-950 text-white rounded-2xl shadow-lg border border-purple-800/40 relative overflow-hidden">
        ...
        <div className="space-y-1.5 z-10">
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight flex items-center gap-3">
            <Compass className="h-7 w-7 text-purple-400 animate-spin-slow" /> Reanalisis Klimatologi ERA5
          </h1>
          <p className="text-xs sm:text-sm text-slate-300 max-w-3xl leading-relaxed">
            Dataset reanalisis iklim global generasi kelima dari ECMWF (1940 - sekarang). Menyediakan analisis komprehensif parameter meteorologi dan klimatologi beresolusi tinggi di seluruh lokasi Indonesia.
          </p>
        </div>
        ...
        {appliedCoords && (
          <div className="z-10 flex items-center gap-2 self-start md:self-auto bg-slate-800/80 px-3 py-2 rounded-xl border border-slate-700/60 text-xs text-slate-300 font-medium">
            ...
            <span>Lokasi: {appliedCoords.lat.toFixed(4)}°, {appliedCoords.lng.toFixed(4)}°</span>
          </div>
        )}
      </div>
